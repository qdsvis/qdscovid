...
export class MapService {
   ...
   load_CRSEPSG3857() {
      ...
      L.tileLayer('https://api.mapbox.com/styles/v1/m0rb1u5/cjvpo5sev1hik1crr1d70ui70/tiles/256/{z}/{x}/{y}?access_token={accessToken}', {
         attribution: '',
         maxZoom: 18,
         id: 'mapbox.streets',
         accessToken: 'pk.eyJ1IjoibTByYjF1NSIsImEiOiJjanZwbmlmZnkyYjk4NDNsNjZlcjR5NXR1In0.mOvVkWostL5jnZyzws_tMw'
      }).addTo(this.map);
